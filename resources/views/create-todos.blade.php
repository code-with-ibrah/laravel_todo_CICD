    ...
    <form id="todo-form" class="space-y-4 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="col-span-2 lg:col-span-1">
            ...
            <input type="text" id="todo-description" placeholder="e.g., Finalize Q3 findings and analysis"
                name="description"   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200">
        </div>
        <div class="col-span-1">
            ...
            <input type="text" id="todo-category" placeholder="e.g., Work"
                name="category"   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200">
        </div>
        <div class="col-span-1">
